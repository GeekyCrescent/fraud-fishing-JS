...
export class ReportController {
  ...
  // ====== GET UNIFICADO ======
  @Get()
  @ApiOperation({ summary: "Buscar reportes (endpoint unificado con filtros)" })
  @ApiQuery({ name: "status", required: false, description: 'Puede ser "active", "completed", "primary" o un ID numérico' })
